...
<head>
    ...
    <title>TechToGo - our revolution</title>
</head>
    ...
    <section class="shop">
        ...
        ?>
            ...
            <form method="post" class="box">
                <img src="../assets/images/<?php echo $fetch_wishlist['image']; ?>">
        ...
        <div class="wishlist_total">
            ...
            <a href="shop.php" class="btn">continue shoping</a> <!-- If shop.php is in pages/, this is correct. Otherwise, update as needed. -->
